<!--
Profile README for: github.com/praneethhere
Repo name must be exactly: praneethhere

Dynamic merged PR section:
- The table between MERGED-PRS markers is updated by .github/workflows/update-readme.yml
- Run manually from GitHub Actions, or let the scheduled workflow refresh it automatically
-->
...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Inter&weight=600&size=22&pause=1000&center=true&vCenter=true&width=900&lines=Building+AI-era+software+with+production+discipline;Open+source+contributor+across+Python%2C+DevTools%2C+Cloud%2C+and+ML;FastAPI+%7C+LangChain+%7C+Kubernetes+%7C+AWS+%7C+Terraform+%7C+DevSecOps)](https://git.io/typing-svg)
...
|---|---|---|
| VS Code | [Support COPILOT_HOME for Copilot CLI state](https://github.com/microsoft/vscode/pull/314917) | 2026-07-31 |
...
![LangGraph](https://img.shields.io/badge/LangGraph-111827?style=flat-square&logo=graphql&logoColor=white)
...
![Elastic Stack](https://img.shields.io/badge/ELK-005571?style=flat-square&logo=elastic&logoColor=white)
